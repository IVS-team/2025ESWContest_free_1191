...
(cl:defclass <DetectedObjectArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (objects
    :reader objects
    :initarg :objects
    :type (cl:vector msg_pkg-msg:DetectedObject)
   :initform (cl:make-array 0 :element-type 'msg_pkg-msg:DetectedObject :initial-element (cl:make-instance 'msg_pkg-msg:DetectedObject))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObjectArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObjectArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msg_pkg-msg:<DetectedObjectArray> is deprecated: use msg_pkg-msg:DetectedObjectArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectedObjectArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'msg_pkg-msg:DetectedObject))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DetectedObjectArray>)))
  ...
  "adedb6bdf017b14d687aa96b3dfb9246")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DetectedObjectArray)))
  "Returns md5sum for a message object of type 'DetectedObjectArray"
  "adedb6bdf017b14d687aa96b3dfb9246")
