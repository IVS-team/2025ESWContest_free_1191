...
set(MSG_I_FLAGS "-Iv2v_com:/root/catkin_ws/src/v2v_com/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
add_custom_target(_v2v_com_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "v2v_com" "/root/catkin_ws/src/v2v_com/msg/V2V.msg" "geometry_msgs/Point:v2v_com/ObstacleData:std_msgs/Header"
)
...
_generate_msg_cpp(v2v_com
  ...
  "${MSG_I_FLAGS}"
  "/opt/ros/melodic/share/geometry_msgs/cmake/../msg/Point.msg;/root/catkin_ws/src/v2v_com/msg/ObstacleData.msg;/opt/ros/melodic/share/std_msgs/cmake/../msg/Header.msg"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/v2v_com)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/v2v_com\")")
  # install generated code
  install(
